 ...
 *
 * Modified version of mp.h for compilation of GMP for WinCE.
 *
 * $Id: mp.h,v 1.2 2004/01/11 10:32:38 argp Exp $
 */
...
void mp_pow _PROTO ((const MINT *, const MINT *, const MINT *, MINT *));
